        ...
        <div className='bg-[#FAFAFA] py-10px-4 lg:px-16'>
            ...
            <div className='create-job-flex'>
              <div className='lg:w-1/2 w-full'>
                ...
                <input type="text" defaultValue={"Web Devloper"} 
                {...register("jobTitle")} 
            ...
            <div className='create-job-flex'>
              <div className='lg:w-1/2 w-full'>
                ...
                <input type="text" placeholder="20 k"
                {...register("minPrice")} 
                className='create-job-input'/>
              </div>
              <div className='lg:w-1/2 w-full'>
                <label className='block mb-2 text-lg'>Maximum Salary</label>
                <input type="text" placeholder="120 k"
                {...register("maxPrice")} 
                className='create-job-input'/>
              </div>
            </div>
            ...
            <div className='create-job-flex'>
              ...
              <div className='lg:w-1/2 w-full'>
                ...
                <input type="text" placeholder="Ex : Rajkot"
            ...
            <div className='create-job-flex'>
              <div className='lg:w-1/2 w-full'>
                ...
                <input type="date" placeholder="Ex : 2024-1-23"
            ...
            {/* 5th row */}
            <div>
              <label className='block mb-2 text-lg'>Requirment Skill Sets:</label>
              <CreatableSelect
            ...
            <div className='w-full'>
              ...
              defaultValue={"This is a job description."}
            ...
            <input type="submit" className='block mt-12 bg-blue text-white font-semmibold px-8 py-2 rounded-sm cursor-pointer' />
          </form>
