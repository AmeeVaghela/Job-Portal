  ...
  return (
    <div><Banner query={query} handleInputChange={handleInputChange} />
      ...
      <div className='bg-[#FAFAFA] md:grid grid-cols-4  gap-8 lg:px-24 px-4 py-12'>
        {/* left side*/}
        <div className='bg=white p-4 eounded'><Sidebar handleChange={handleChange} handleClick={handleClick} /></div>
        {/* job card*/}
        ...
        {/* right side*/}
        <div className='bg-white p-4 eounded'><Newsletter/></div>
